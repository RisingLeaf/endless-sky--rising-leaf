...
{
public:
  static std::shared_future<void>
  BeginLoad(TaskQueue &queue, const PlayerInfo &player, bool onlyLoadData, bool debugMode, bool preventUpload);
  ...
  static const Set<std::vector<File::ShaderString>> &Shaders();
