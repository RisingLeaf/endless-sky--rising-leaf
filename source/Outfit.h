...
#define ADD_SPECIAL_DAMAGE(x) \
  ...
  static constexpr std::array<std::string_view, 151> AttributeNameTable =
  {
    "cargo space",
    "outfit space",
    "weapon capacity",
...
public:
  ...
  [[nodiscard]] constexpr const double &GetIndexed(const size_t attribute) const { return QuickLoadDictionary[attribute]; }
