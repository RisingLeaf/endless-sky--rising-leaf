...
public:
  constexpr GameVersion(unsigned major, unsigned minor, unsigned release, unsigned patch = 0, bool fullRelease = true);
...
consteval GameVersion GameVersion::Running() { return {0, 11, 1, 0, false}; }
