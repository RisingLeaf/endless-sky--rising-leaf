...
void BatchDrawList::SetCenter(const Point &center) { this->center = center; }
...
bool BatchDrawList::AddVisual(const Body &visual) { return Add(visual, (visual.Position() - center) * zoom, 1.f); }
...
{
  if(Cull(body, position)) return false;
