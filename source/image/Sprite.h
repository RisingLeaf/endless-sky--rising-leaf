...
public:
	...
	const graphics_layer::TextureHandle &Texture() const;
	const graphics_layer::TextureHandle &Texture(bool isHighDPI) const;

	const graphics_layer::TextureHandle &SwizzleMask() const;
	const graphics_layer::TextureHandle &SwizzleMask(bool isHighDPI) const;

private:
	std::string name;

	graphics_layer::TextureHandle texture[2] = {};
	graphics_layer::TextureHandle swizzleMask[2] = {};
