...
namespace GraphicsTypes
{
  ...
  struct BlendState
  {
    ...
    {
      return this->BlendingEnabled == b.BlendingEnabled && this->SRCColor == b.SRCColor &&
             this->DSTColor == b.DSTColor && this->SRCAlpha == b.SRCAlpha && this->DSTAlpha == b.DSTAlpha;
    }
  };
  ...
  struct VertexLayout
  {
    ...
    {
      constexpr auto ValuesEquals =
          [](const std::vector<std::pair<DataType, uint32_t>> &a, const std::vector<std::pair<DataType, uint32_t>> &b)
      {
        for(size_t i = 0; i < a.size(); i++)
          if(a[i].first != b[i].first || a[i].second != b[i].second) return false;
        return true;
      };
      return this->vertex_size == b.vertex_size && this->values.size() == b.values.size() &&
             ValuesEquals(this->values, b.values);
    }
  };
  ...
  struct RenderState
  {
    ...
    {
      return this->DrawPrimitiveType == b.DrawPrimitiveType && this->Blending == b.Blending &&
             this->Culling == b.Culling && this->DepthTest == b.DepthTest && this->DepthWrite == b.DepthWrite &&
             this->DepthCompare == b.DepthCompare && this->WireFrame == b.WireFrame && this->ColorMask == b.ColorMask &&
             this->PipelineVertexLayout == b.PipelineVertexLayout;
    }
  };
  ...
  struct FrameBufferInfo
  {
    ...
    {
      return this->Width == other.Width && this->Height == other.Height && this->Samples == other.Samples &&
             this->HasColor == other.HasColor && this->HasDepth == other.HasDepth &&
  ...
  public:
    ...
    virtual void CreateShader(
        std::unique_ptr<ShaderInstance>       &shader_instance,
    ...
    virtual void CreateTexture(
        std::unique_ptr<TextureInstance> &texture_instance,
        const TextureInfo                &texture_info,
        const void                       *in_data,
        std::string_view                  name) const = 0;

    virtual void CreateRenderBuffer(
        std::unique_ptr<RenderBufferInstance> &render_buffer_instance,
        const FrameBufferInfo                 &create_info,
        std::string_view                       name) const                                                                          = 0;
    ...
    virtual void DispatchCompute(
        ...
        const TextureInstance *const *texture_instance,
        int                           count,
        int                           num_x,
        int                           num_y,
        int                           num_z) const                                                      = 0;
    ...
    virtual void
    DrawIndexed(size_t start, size_t count, const BufferInstance *buffer_instance, PrimitiveType prim_type) const = 0;
