...
public:
  ...
  {
  public:
    explicit PositionIterator(const FormationPattern &pattern, double centerBodyRadius);
...
private:
  ...
  Point Position(unsigned int ring, unsigned int lineNr, unsigned int repeatNr, unsigned int lineRepeatPosition) const;
