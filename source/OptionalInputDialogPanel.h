...
public:
  template <class T>
  static OptionalInputDialogPanel *RequestInteger(
      T *t,
  ...
  template <class T>
  static OptionalInputDialogPanel *RequestDouble(
      T *t,
...
private:
  explicit OptionalInputDialogPanel(
      DialogInit                                &init,
...
template <class T>
OptionalInputDialogPanel *OptionalInputDialogPanel::RequestInteger(
    T *t,
    void (T::*fun)(std::optional<int>),
    std::string        message,
...
template <class T>
OptionalInputDialogPanel *OptionalInputDialogPanel::RequestDouble(
    T *t,
    void (T::*fun)(std::optional<double>),
    std::string           message,
