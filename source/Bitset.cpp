...
size_t Bitset::Size() const noexcept { return bits.size() * BITS_PER_BLOCK; }


// Returns the number of bits this bitset has reserved.
size_t Bitset::Capacity() const noexcept { return bits.capacity() * BITS_PER_BLOCK; }


// Resizes the bitset to hold at least the specific amount of bits.
void Bitset::Resize(size_t size) { bits.resize(size / BITS_PER_BLOCK + 1); }


// Clears the bitset. After this call this bitset is empty.
void Bitset::Clear() noexcept { bits.clear(); }
...
bool Bitset::None() const noexcept { return !Any(); }
