...
public:
  ...
  template <class T>
  static DialogPanel *CallFunctionOnExit(
      T *t,
      void (T::*fun)(bool),
      std::string message,
  ...
  template <class T>
  static DialogPanel *CallFunctionIfOk(
      T *t,
      void (T::*fun)(),
      std::string message,
      Truncate    truncate          = Truncate::NONE,
  ...
  static DialogPanel *MissionOfferDialog(
      std::string   message,
      PlayerInfo   &player,
  ...
  template <class T>
  static DialogPanel *RequestString(
      T *t,
      void (T::*fun)(const std::string &),
      std::string message,
      std::string initialValue      = "",
      Truncate    truncate          = Truncate::NONE,
      bool        allowsFastForward = false);
  template <class T>
  static DialogPanel *RequestInteger(
      T *t,
      void (T::*fun)(int),
      std::string        message,
      ...
      bool               allowsFastForward = false);
  template <class T>
  static DialogPanel *RequestDouble(
      T *t,
      void (T::*fun)(double),
      std::string           message,
  ...
  // If the user selects "ok", the callback is called with the input.
  template <class T>
  static DialogPanel *RequestStringWithValidation(
      T *t,
      void (T::*fun)(const std::string &),
      ...
      bool                                     allowsFastForward = false);
  template <class T>
  static DialogPanel *RequestIntegerWithValidation(
      T *t,
      void (T::*fun)(int),
      ...
      bool                     allowsFastForward = false);
  template <class T>
  static DialogPanel *RequestDoubleWithValidation(
      T *t,
      void (T::*fun)(double),
  ...
  template <class T>
  static DialogPanel *RequestPositiveInteger(
      T *t,
      void (T::*fun)(int),
      std::string        message,
      std::optional<int> initialValue      = std::nullopt,
...
template <class T>
DialogPanel::FunctionButton::FunctionButton(
    T                 *panel,
    const std::string &buttonLabel,
    SDL_Keycode        buttonKey,
    bool (T::*buttonAction)(const std::string &)) :
  buttonLabel(buttonLabel), buttonKey(buttonKey), buttonAction(std::bind(buttonAction, panel, std::placeholders::_1))
{
}


template <class T>
DialogPanel *DialogPanel::CallFunctionOnExit(
    T *t,
    void (T::*fun)(bool),
    std::string message,
    Truncate    truncate,
...
template <class T>
DialogPanel *
DialogPanel::CallFunctionIfOk(T *t, void (T::*fun)(), std::string message, Truncate truncate, bool allowsFastForward)
{
  DialogInit init;
  init.message           = std::move(message);
...
template <class T>
DialogPanel *DialogPanel::RequestString(
    T *t,
    void (T::*fun)(const std::string &),
    std::string message,
    std::string initialValue,
...
template <class T>
DialogPanel *DialogPanel::RequestInteger(
    T *t,
    void (T::*fun)(int),
    std::string        message,
    ...
    bool               allowsFastForward)
{
  DialogInit init;
  init.message = std::move(message);
  if(initialValue.has_value()) init.initialValue = std::to_string(initialValue.value());
...
template <class T>
DialogPanel *DialogPanel::RequestDouble(
    T *t,
    void (T::*fun)(double),
    std::string           message,
    ...
    bool                  allowsFastForward)
{
  DialogInit init;
  init.message = std::move(message);
  if(initialValue.has_value()) init.initialValue = Format::StripCommas(Format::Number(initialValue.value(), 5));
...
template <class T>
DialogPanel *DialogPanel::RequestStringWithValidation(
    T *t,
    void (T::*fun)(const std::string &),
    std::function<bool(const std::string &)> validate,
    std::string                              message,
...
template <class T>
DialogPanel *DialogPanel::RequestIntegerWithValidation(
    T *t,
    void (T::*fun)(int),
    std::function<bool(int)> validate,
    std::string              message,
...
template <class T>
DialogPanel *DialogPanel::RequestDoubleWithValidation(
    T *t,
    void (T::*fun)(double),
    std::function<bool(double)> validate,
    std::string                 message,
...
template <class T>
DialogPanel *DialogPanel::RequestPositiveInteger(
    T *t,
    void (T::*fun)(int),
    std::string        message,
    std::optional<int> initialValue,
    ...
    bool               allowsFastForward)
{
  return DialogPanel::RequestIntegerWithValidation(
      t,
      fun,
