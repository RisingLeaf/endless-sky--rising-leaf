...
namespace VulkanBootstrap
{
  ...
  VkDescriptorSetLayoutBinding GetDescriptorSetLayoutBinding(
      ...
      VulkanTranslate::DescriptorType type);

  VkDescriptorSetLayoutCreateInfo
  GetDescriptorSetLayoutCreate(const std::vector<VkDescriptorSetLayoutBinding> &bindings);

  //////////////
  /// ATTACHMENTS
  //////////////
  VkAttachmentDescription GetAttachmentDescription(
      VulkanTranslate::AttachmentType type,
  ...
  /// RENDER PASS
  //////////////
  VkRenderPassCreateInfo GetRenderPassCreate(
  ...
  /// IMAGE
  //////////////
  VkImageCreateInfo GetImageCreate(
  ...
  VkImageViewCreateInfo GetimageViewCreate(
      VkImage                    image,
  ...
  VkSamplerCreateInfo GetSamplerCreate(
      float                             max_anisotropy,
      float                             max_lod,
      GraphicsTypes::TextureAddressMode address_mode,
      GraphicsTypes::TextureFilter      filter);

  VkImageMemoryBarrier GetImageMemoryBarrierWithoutAccess(
      VkImage            image,
  ...
  VkBufferImageCopy GetSimpleBufferImageCopyRegion(
      VkImageAspectFlags aspect,
      uint32_t           width,
      uint32_t           height,
      uint32_t           depth,
  ...
  /// FRAME BUFFER
  //////////////
  VkFramebufferCreateInfo GetFrameBufferCreate(
  ...
  /// SWAP CHAIN
  //////////////
  VkSwapchainCreateInfoKHR GetSwapChainCreate(
