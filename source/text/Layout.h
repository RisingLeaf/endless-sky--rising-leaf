...
inline Layout::Layout(int width) noexcept : width(width) {}


inline Layout::Layout(Alignment alignment) noexcept : align(alignment) {}


inline Layout::Layout(Truncate truncateType) noexcept : truncate(truncateType) {}


inline Layout::Layout(int width, Alignment alignment) noexcept : width(width), align(alignment) {}


inline Layout::Layout(int width, Truncate truncateType) noexcept : width(width), truncate(truncateType) {}
