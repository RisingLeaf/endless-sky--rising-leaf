...
public:
  ...
  SolarGeneration
  GetSolarGeneration(const Point &shipPosition, double shipRamscoop, double shipCollection, double shipCollectionHeat)
      const;
...
private:
  void LoadObject(const DataNode &node, Set<Planet> &planets, const ConditionsStore *playerConditions, int parent = -1);
